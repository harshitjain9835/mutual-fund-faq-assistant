...
Build a facts-only FAQ assistant for mutual fund schemes using Groww as a reference product context. The assistant answers objective, verifiable queries related to mutual funds by retrieving information exclusively from official public sources such as AMC websites, AMFI, and SEBI.
...
- Currently limited to these example URLs:
...
- Answer facts-only queries, such as:
  ...
  - Benchmark index
  - Fund management details (e.g., fund manager, management tenure)
